...
define('SU_DEFAULT_URL_FLAGS',  0x0001);    #Defaulr flags for new entries
...
define('SU_ACCESS_NEW_USER',    SU_USER_HOP);
define('SU_ACCESS_LOCK_USER',   SU_USER_HOP);
define('SU_ACCESS_REVIEW_URL',  SU_USER_OP);
define('SU_ACCESS_LOCK_URL',    SU_USER_HOP);
define('SU_ACCESS_UNLOCK_URL',  SU_DUSE_SOP);
